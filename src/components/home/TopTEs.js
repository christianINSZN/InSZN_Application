...
function TopTEs() {
  ...
  const columns = useMemo(() => [
    ...
    columnHelper.accessor('averagePPA_rush', {
      id: 'Rush PPA',
  ...
  if (isLoading) {
    return (
      <div className="p-0 shadow-xl rounded-lg h-full">
        <h2 className="flex items-center justify-center text-xl bg-[#235347] font-bold text-white shadow-lg border-b border-[#235347] h-[40px] rounded">Top-25 TEs (PPA)</h2>
