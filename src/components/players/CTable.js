// In src/components/players/CTable.js
...
const CTable = ({ data, navigate, filterGamesPlayed, filterPlayerName, filterTeamName, year }) => {
  ...
  const cColumns = useMemo(() => [
    ...
    columnHelper.accessor('grades_offense', {
      ...
      sortDescFirst: true,
      cell: info => {
        console.log('Grade Offense Value for C:', info.getValue());
  ...
  return (
    <div className="bg-gray-100 p-4 rounded-lg shadow">
      <h2 className="text-lg font-semibold mb-2 text-gray-700">Centers</h2>
