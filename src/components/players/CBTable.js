...
const CBTable = ({ data, navigate, filterGamesPlayed, filterPlayerName, filterTeamName, year }) => {
  ...
  return (
    <div className="p-0 shadow-xl rounded-lg">
      <h2 className="flex items-center justify-center text-md sm:text-md bg-[#235347] font-bold text-white shadow-lg border-b border-[#235347] h-auto sm:h-auto rounded-t-lg">Cornerbacks</h2>
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 backdrop-filter backdrop-blur-md rounded-lg">
          <div className="p-6 bg-white rounded-lg shadow-lg text-center">
            <p className="text-gray-500 mb-2">Cornerback Player Profiles Coming Soon</p>
          </div>
        </div>
      </div>
    </div>
