...
const GameLogReceiving = ({ playerId, year, weeklyGrades, teamGames, allPlayerPercentiles, selectedZone, selectedMetric, selectedDistance }) => {
...
export default GameLogReceiving;