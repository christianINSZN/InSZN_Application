        ...
        <table className="w-full text-left border-collapse">
          <thead className="sticky top-0 bg-white z-2">
            <tr>
              ...
              <th className="p-1 text-[13px] font-semibold border-b border-gray-400 text-black" style={{ textAlign: 'middle', lineHeight: '1.2' }}>RunG</th>
              ...
              <th className="p-1 text-[13px] font-semibold border-b border-gray-400 text-black" style={{ textAlign: 'middle', lineHeight: '1.2' }}>YPA</th>
          ...
          <tbody>
            {sortedGames.map((game, index) => {
              ...
              let grades_pass = weekGrade['grades_run'] !== undefined && weekGrade['grades_run'] !== null ? weekGrade['grades_run'].toFixed(1) : 'N/A';
              let grades_run = weekGrade['grades_pass_route'] !== undefined && weekGrade['grades_pass_route'] !== null ? weekGrade['grades_pass_route'].toFixed(1) : 'N/A';
              let attempts = weekGrade['attempts'] !== undefined && weekGrade['attempts'] !== null ? weekGrade['attempts'] : 'N/A';
              let ypa = weekGrade['ypa'] !== undefined && weekGrade['ypa'] !== null ? weekGrade['ypa'] : 'N/A';
              ...
              let fumbles = weekGrade['fumbles'] !== undefined && weekGrade['fumbles'] !== null ? weekGrade['fumbles'] : 'N/A';
              ...
              return (
                <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-navy-400'}>
                  ...
                  <td className="p-1 text-xs text-left border-b border-gray-300" style={{ verticalAlign: 'middle', lineHeight: '1.1' }}>{grades_pass}</td>
                  <td className="p-1 text-xs text-left border-b border-gray-300" style={{ verticalAlign: 'middle', lineHeight: '1.1' }}>{grades_run}</td>
                  <td className="p-1 text-xs text-left border-b border-gray-300" style={{ verticalAlign: 'middle', lineHeight: '1.1' }}>{attempts}</td>
                  <td className="p-1 text-xs text-left border-b border-gray-300" style={{ verticalAlign: 'middle', lineHeight: '1.1' }}>{ypa}</td>
                  ...
                  <td className="p-1 text-xs text-left border-b border-gray-300" style={{ verticalAlign: 'middle', lineHeight: '1.1' }}>{fumbles}</td>
                </tr>
              );
            })}
          </tbody>
