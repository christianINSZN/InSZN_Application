...
GRADE_CONFIG = {
    ...
    "C": {
        ...
        "extra_columns": ["player_game_count", "grades_offense", "snap_counts_offense", "hurries_allowed", "pressures_allowed", "hits_allowed", "sacks_allowed", "pbe"]  # Add specific stats if available
    },
    "G": {
        "csv_dir": "Blocking/SeasonReports",
        "csv_file": "BlockingGrades.csv",
