...
GRADE_CONFIG = {
    ...
    "C": {
        ...
        "extra_columns": ["player_game_count"]  # Add specific stats if available
    },
    "G": {
        "csv_dir": "Blocking/SeasonReports",
        "csv_file": "BlockingGrades.csv",
        "stat_column": "grades_offense",
        "extra_columns": ["player_game_count"]
    },
    "T": {
        "csv_dir": "Blocking/SeasonReports",
        "csv_file": "BlockingGrades.csv",
    ...
    "LB": {
        ...
        "extra_columns": ["player_game_count"]  # Add specific stats if available (e.g., tackles, sacks)
    },
    "CB": {
        "csv_dir": "Defense/SeasonReports",
        "csv_file": "DefenseGrades.csv",
