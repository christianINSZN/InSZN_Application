...
COLUMNS_TO_EXCLUDE = [
    'position',
    'opponent_id',
    'playerId', 'team', 'team_name', 'franchise_id', 'player_id_PFF'
    # Add any other columns you want to exclude here
]
# ============================================================================

# Fetch all columns from Players_BlockingPass_Weekly
...
snap_count_cols = ['snap_counts_pass_block', 'true_pass_set_snap_counts_pass_play']
...
weighted_avg_configs = [
    ...
    ('grades_pass_block_adjusted', 'snap_counts_pass_block'),
    ('non_spike_pass_block_percentage', 'snap_counts_pass_block'),
    ('pass_block_percent', 'snap_counts_pass_block'),
    ('pbe', 'snap_counts_pass_block'),
    ('true_pass_set_grades_pass_block', 'true_pass_set_snap_counts_pass_play'),
    ('true_pass_set_grades_pass_block_adjusted', 'true_pass_set_snap_counts_pass_play'),
    ('true_pass_set_non_spike_pass_block_percentage', 'true_pass_set_snap_counts_pass_play'),
    ('true_pass_set_pass_block_percent', 'true_pass_set_snap_counts_pass_play'),
    ('true_pass_set_pbe', 'true_pass_set_snap_counts_pass_play')
]
...
cursor.execute("DROP TABLE IF EXISTS Team_PassBlocking_Weekly;")
...
print(f"✓ Team_PassBlocking_Weekly table created with {len(team_df)} records ({year_range})")
if excluded_found:
