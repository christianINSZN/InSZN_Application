...
# Define table for Blocking Grades Season data
TABLE_NAME = "Players_BlockingGrades_Season"
...
# Load Blocking Grades season data and dynamically build metric columns
pff_data = {}
