...
# Define table for Passing Pressure Season data
TABLE_NAME = "Players_PassingPressure_Season"
...
# Load Passing Pressure season data and dynamically build metric columns
pff_data = {}
