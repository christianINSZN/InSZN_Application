...
# Define table for Passing Time In Pocket Season data
TABLE_NAME = "Players_PassingTimeInPocket_Season"
...
# Load Passing Time In Pocket season data and dynamically build metric columns
pff_data = {}
