...
# Define table for Receiving Pressure Season data
TABLE_NAME = "Players_ReceivingScheme_Season"
...
# Load Receiving Pressure season data and dynamically build metric columns
pff_data = {}
