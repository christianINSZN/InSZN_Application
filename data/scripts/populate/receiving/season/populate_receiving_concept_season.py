...
# Define table for Receiving Concept Season data
TABLE_NAME = "Players_ReceivingConcept_Season"
...
# Load Receiving Concept season data and dynamically build metric columns
pff_data = {}
