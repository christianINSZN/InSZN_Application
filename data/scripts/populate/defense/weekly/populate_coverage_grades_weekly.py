...
# Load Defense Coverage Grades weekly data and dynamically build all columns
pff_data = {}
...
if not BASE_DIR.exists():
    ...
    for csv_file in BASE_DIR.glob("*_CoverageGrades.csv"):  # Match {year}_{week}_CoverageGrades.csv
