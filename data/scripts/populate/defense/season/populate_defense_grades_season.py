...
# Define table for Defense Grades Season data
TABLE_NAME = "Players_DefenseGrades_Season"
...
# Load Defense Grades season data and dynamically build metric columns
pff_data = {}
...
if BASE_DIR.exists():
    for csv_file in BASE_DIR.glob("*_DefenseGrades.csv"):
